  ...
  <div class="flex flex-col h-full">
    ...
    <nav class="flex-1 p-6">
      <div class="space-y-2">
        ...
        <a
          href="/settings"
          on:click={() => handleItemClick('/settings')}
          class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors {$page.url.pathname.startsWith('/settings') ? 'bg-blue-50 text-blue-700' : ''}"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
